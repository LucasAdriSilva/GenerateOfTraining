...
class Exercises:
    ...
    def getExercisesBodyWeight():
        ...
        { 'name': 'Negativas de Remada', 'url': 'https://treinomestre.com.br/wp-content/uploads/2021/11/remada-articulada.jpg', 'category': 'Pull', 'nivel': 1, 'type': 'Horizontal', 'division': ' Rows/Barra Australiana - Horizontal', 'required': ['Argolas', 'Paralelas', 'Barra Fixa', 'Trx'] },
        { 'name': 'Rows/Barra Australiana', 'url': 'https://www.sport.es/labolsadelcorredor/wp-content/uploads/2018/05/Australian-pull-up.jpg', 'category': 'Pull', 'nivel': 2, 'type': 'Horizontal', 'division': ' Rows/Barra Australiana - Horizontal', 'default': 'true', 'required': ['Argolas', 'Paralelas', 'Barra Fixa', 'Trx'] },
        { 'name': 'Wide Rows (pegada aberta)', 'url': 'https://www.spotebi.com/wp-content/uploads/2015/04/wide-row-exercise-illustration.jpg', 'category': 'Pull', 'nivel': 3, 'type': 'Horizontal', 'division': ' Rows/Barra Australiana - Horizontal', 'required': ['Argolas', 'Paralelas', 'Barra Fixa', 'Trx'] },
        ...
        { 'name': 'Archer Rows (braço esticado)/Tuck Front Lever', 'url': 'https://cdn.vectorstock.com/i/1000x1000/36/80/woman-doing-upper-back-exercise-archer-with-long-r-vector-43113680.webp', 'category': 'Pull', 'nivel': 5, 'type': 'Horizontal', 'division': ' Rows/Barra Australiana - Horizontal', 'required': ['Argolas', 'Paralelas', 'Barra Fixa', 'Trx'] },
        { 'name': 'Straddle One Arm Rows', 'url': 'https://www.shutterstock.com/image-vector/man-doing-single-arm-bent-600w-2101536073.jpg', 'category': 'Pull', 'nivel': 6, 'type': 'Horizontal', 'division': ' Rows/Barra Australiana - Horizontal', 'required': ['Argolas', 'Paralelas', 'Barra Fixa', 'Trx'] },
        { 'name': 'Pull Ups com ajuda ou elastico', 'url': 'https://network.grupoabril.com.br/wp-content/uploads/sites/2/2017/01/xxxx.jpg?quality=85&strip=all&w=1024', 'category': 'Pull', 'nivel': 0, 'type': 'Vertical', 'division': 'Barra Fixa (Pull Ups) - Vertical', 'required': ['Barra Fixa', 'Superband'] },
        { 'name': 'Pull Ups negativo', 'url': 'https://www.fitstream.com/images/bodyweight-training/bodyweight-exercises/negative-pull-up-main.png', 'category': 'Pull', 'nivel': 2, 'type': 'Vertical', 'division': 'Barra Fixa (Pull Ups) - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Pull Ups em L-sit', 'url': 'https://i.pinimg.com/564x/f3/b2/eb/f3b2eb20fc9472333072dab45e4140a6.jpg', 'category': 'Pull', 'nivel': 4, 'type': 'Vertical', 'division': 'Barra Fixa (Pull Ups) - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Wide Pull Ups (pegada aberta)', 'url': 'https://images.squarespace-cdn.com/content/v1/57efdb4cd482e918dc2a900f/1658358689971-JZXGL3SS7MY5ES2S9VVT/extra+wide+pull+up+grip.JPG?format=500w', 'category': 'Pull', 'nivel': 5, 'type': 'Vertical', 'division': 'Barra Fixa (Pull Ups) - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Wide Pull Ups em L-sit', 'url': 'https://www.fitliferegime.com/wp-content/uploads/2023/01/Muscle-Worked-During-Pull-Ups-1024x683.webp?ezimgfmt=ng:webp/ngcb1', 'category': 'Pull', 'nivel': 6, 'type': 'Vertical', 'division': 'Barra Fixa (Pull Ups) - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Archer Pull ups', 'url': 'https://kengurupro.eu/wp-content/uploads/2020/10/k-005-1-1.jpg', 'category': 'Pull', 'nivel': 6, 'type': 'Vertical', 'division': 'One Arm Pull Ups (um braço) - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Pull Ups com ajuda', 'url': 'https://network.grupoabril.com.br/wp-content/uploads/sites/2/2017/01/xxxx.jpg?quality=85&strip=all&w=1024', 'category': 'Pull', 'nivel': 1, 'type': 'Vertical', 'division': 'Weigthed Pull Ups - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Pull Ups', 'url': 'http://2.bp.blogspot.com/-kKolopOtBl8/UDvUdp8cDTI/AAAAAAAABw8/KwV1AzFxPsE/s400/FITNESS_proradicalskate.jpg', 'category': 'Pull', 'nivel': 3, 'type': 'Vertical', 'division': 'Weigthed Pull Ups - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Pull Ups +18% seu peso', 'url': 'https://st4.depositphotos.com/13768208/40092/i/450/depositphotos_400928346-stock-photo-cross-fit-seminar-staff-member.jpg', 'category': 'Pull', 'nivel': 4, 'type': 'Vertical', 'division': 'Weigthed Pull Ups - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Pull Ups +35% seu peso', 'url': 'https://st4.depositphotos.com/13768208/40092/i/450/depositphotos_400928346-stock-photo-cross-fit-seminar-staff-member.jpg', 'category': 'Pull', 'nivel': 5, 'type': 'Vertical', 'division': 'Weigthed Pull Ups - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Pull Ups +50% seu peso', 'url': 'https://st4.depositphotos.com/13768208/40092/i/450/depositphotos_400928346-stock-photo-cross-fit-seminar-staff-member.jpg', 'category': 'Pull', 'nivel': 6, 'type': 'Vertical', 'division': 'Weigthed Pull Ups - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Kipping Pull-ups', 'url': 'https://i.ytimg.com/vi_webp/AyPTCEXTjOo/maxresdefault.webp', 'category': 'Pull', 'nivel': 2, 'type': 'Vertical', 'division': 'Pull Ups Explosivos - Vertical', 'required': 'Barra Fixa' },
        { 'name': 'Pull-ups', 'url': 'http://2.bp.blogspot.com/-kKolopOtBl8/UDvUdp8cDTI/AAAAAAAABw8/KwV1AzFxPsE/s400/FITNESS_proradicalskate.jpg', 'category': 'Pull', 'nivel': 3, 'type': 'Vertical', 'division': 'Pull Ups Explosivos - Vertical', 'required': 'Barra Fixa' },
        ...
        { 'name': 'L-sit', 'url': 'https://www.shutterstock.com/image-vector/l-sit-hang-on-bar-600w-796165771.jpg', 'category': 'Core', 'nivel': 3, 'type': 'Abdômen', 'division': 'L-sit (core) - Abdômen', 'default': 'true', 'required': 'Barra Fixa', "segs": 'true' },
        ...
        { 'name': 'L-sit Supinado', 'url': 'https://i.ytimg.com/vi/WHi1bvZLwlw/maxresdefault.jpg', 'category': 'Core', 'nivel': 6, 'type': 'Abdômen', 'division': 'L-sit (core) - Abdômen', 'required': 'Barra Fixa', "segs": 'true' },
        { 'name': 'Prancha Abdominal', 'url': 'https://corpoesbelto.com.br/wp-content/uploads/2018/03/Exerc%C3%ADcio-de-Prancha.jpg', 'category': 'Core', 'nivel': 1, 'type': 'Abdômen', 'division': 'Abdominal na Rodinha - Abdômen', 'required': '', "segs": 'true' },
        ...
        { 'name': 'Rodinha de Joelhos', 'url': 'https://treinomestre.com.br/wp-content/uploads/2017/02/roda-abdominal-exercicio.jpg', 'category': 'Core', 'nivel': 3, 'type': 'Abdômen', 'division': 'Abdominal na Rodinha - Abdômen', 'required': ['Rodinha Abdominal', 'Argolas'] },
        { 'name': 'Rodinha na Rampa Inclinada', 'url': 'https://treinomestre.com.br/wp-content/uploads/2017/02/roda-abdominal-exercicio.jpg', 'category': 'Core', 'nivel': 4, 'type': 'Abdômen', 'division': 'Abdominal na Rodinha - Abdômen', 'required': ['Rodinha Abdominal', 'Argolas'] },
        { 'name': 'Rodinha no chão Negativa', 'url': 'https://treinomestre.com.br/wp-content/uploads/2017/02/roda-abdominal-exercicio.jpg', 'category': 'Core', 'nivel': 5, 'type': 'Abdômen', 'division': 'Abdominal na Rodinha - Abdômen', 'required': ['Rodinha Abdominal', 'Argolas'] },
        { 'name': 'Rodinha no chão', 'url': 'https://treinomestre.com.br/wp-content/uploads/2017/02/roda-abdominal-exercicio.jpg', 'category': 'Core', 'nivel': 6, 'type': 'Abdômen', 'division': 'Abdominal na Rodinha - Abdômen', 'required': ['Rodinha Abdominal', 'Argolas'] },
        ...
        { 'name': 'Meio Toes to Bar (perna até a metade)', 'url': 'https://i.ytimg.com/vi/6dHvTlsMvNY/maxresdefault.jpg', 'category': 'Core', 'nivel': 3, 'type': 'Abdômen', 'division': 'Toes To Bar - Abdômen', 'required': 'Barra Fixa' },
        { 'name': 'Straight Leg Toes to bar (até a barra)', 'url': 'https://i.ytimg.com/vi/6dHvTlsMvNY/maxresdefault.jpg', 'category': 'Core', 'nivel': 4, 'type': 'Abdômen', 'division': 'Toes To Bar - Abdômen', 'required': 'Barra Fixa' },
        { 'name': 'Straight Leg Toes to bar (até a barra)', 'url': 'https://i.ytimg.com/vi/6dHvTlsMvNY/maxresdefault.jpg', 'category': 'Core', 'nivel': 5, 'type': 'Abdômen', 'division': 'Toes To Bar - Abdômen', 'required': 'Barra Fixa' },
        { 'name': 'Weighted Toes to bar ', 'url': 'https://i.ytimg.com/vi/xX9Hzi7Onnw/maxresdefault.jpg', 'category': 'Core', 'nivel': 6, 'type': 'Abdômen', 'division': 'Toes To Bar - Abdômen', 'required': 'Barra Fixa' },
